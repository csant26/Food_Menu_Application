...
namespace Food_Menu_Application.Migrations
{
    ...
    [Migration("20240609043631_Second Migration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Food_Menu_Application.Models.Dish", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Name = "Pepperoni",
                            Price = 600.29999999999995
                        });
                });

            modelBuilder.Entity("Food_Menu_Application.Models.DishIngredient", b =>
                {
            ...
            modelBuilder.Entity("Food_Menu_Application.Models.Ingredient", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Food_Menu_Application.Models.DishIngredient", b =>
                {
                    b.HasOne("Food_Menu_Application.Models.Dish", "Dish")
                        .WithMany("DishIngredients")
                        .HasForeignKey("DishId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Food_Menu_Application.Models.Ingredient", "Ingredient")
                        .WithMany("DishIngredients")
